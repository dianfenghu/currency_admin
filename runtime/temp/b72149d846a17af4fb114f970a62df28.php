<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"D:\wamp\www\web1\public/../application/admin\view\group\index.html";i:1493822287;s:68:"D:\wamp\www\web1\public/../application/common\view\Public\admin.html";i:1493820428;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
function fun(id){
    $.post("<?php echo url('group/auth'); ?>",{id:id},function(data){
		layer.open({
		  title:'权限分配',
		  area: ['60%', '60%']
		  ,content: '<div class="layui-form"><table class="layui-table"><thead><tr><th><input name="" lay-skin="primary" lay-filter="allChoose" type="checkbox"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><i class="layui-icon">口</i></div></th><th colspan="4">权限分配</th></tr></thead><tbody><tr><td><input name="" lay-skin="primary" type="checkbox"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><i class="layui-icon"></i></div></td><td>贤心</td><td>汉族</td><td>1989-10-14</td><td>人生似修行</td></tr></tbody></table></div>'
		}); 
	})
}
