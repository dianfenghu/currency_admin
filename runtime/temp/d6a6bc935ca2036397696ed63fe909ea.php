<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"C:\Users\my\Desktop\www\currency_admin\public/../application/admin\view\content\add.html";i:1493649596;s:90:"C:\Users\my\Desktop\www\currency_admin\public/../application/common\view\Public\admin.html";i:1493905016;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
	...
	<form class="layui-form layui-form-pane" action="" method='POST'>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="name" required="" lay-verify="required" placeholder="请输入内容标题" autocomplete="off" class="layui-input layui-form-danger">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<select name="type" lay-verify="required">
					...
					<?php if(is_array($listtype) || $listtype instanceof \think\Collection || $listtype instanceof \think\Paginator): $i = 0; $__LIST__ = $listtype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$votype): $mod = ($i % 2 );++$i;if(empty($votype['son']) || (($votype['son'] instanceof \think\Collection || $votype['son'] instanceof \think\Paginator ) && $votype['son']->isEmpty())): ?>
						<option value="<?php echo $votype['id']; ?>"><?php echo $votype['name']; ?></option>
						<?php endif; endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</div>
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="content" id='content' style="display: none;" placeholder="请输入内容"></textarea>
			</div>
		</div>
		<div class="layui-form-item">
		  <button class="layui-btn" lay-submit="" lay-filter="formadd" href-url="<?php echo url('type/add'); ?>">立即提交</button>
		</div>
	</form>
</div>
