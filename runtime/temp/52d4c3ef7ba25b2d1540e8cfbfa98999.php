...
<button class="layui-btn add" href-url="<?php echo url('admin/user/add'); ?>">
...
<table class="layui-table" lay-even="" lay-skin="">
	...
	<tr>
		...
		<td><?php echo !empty($vo['status'])?'启用' : '禁用'; ?></td>
		<td><?php echo date('Y-m-d H:i:s',$vo['addtime']); ?></td>
		<td>			
			<div class="layui-btn-group ">
				<button class="layui-btn layui-btn-mini update" href-url="<?php echo url('admin/user/update?id='.$vo['id']); ?>">编辑</button>
				<?php if(($debug == true)): ?><button class="layui-btn layui-btn-mini del" href-url="<?php echo url('admin/user/delete?id='.$vo['id']); ?>">删除</button><?php endif; ?>
			</div>
		</td>
	</tr>
	<?php endforeach; endif; else: echo "" ;endif; ?>
