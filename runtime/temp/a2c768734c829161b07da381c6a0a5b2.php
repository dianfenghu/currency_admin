<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"C:\Users\my\Desktop\www\currency_admin\public/../application/admin\view\type\index.html";i:1493649596;s:90:"C:\Users\my\Desktop\www\currency_admin\public/../application/common\view\Public\admin.html";i:1493905016;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<button class="layui-btn add" href-url="<?php echo url('admin/type/add'); ?>">
...
<table class="layui-table" lay-even="" lay-skin="nob">
	...
	<tr title="<?php echo $vo['describe']; ?>">
		...
		<td title="[x代表没有]"><?php echo $vo['info']; ?></td>
		<td><?php echo !empty($vo['status'])?'激活':'隐藏'; ?></td>
		<td>			
			<div class="layui-btn-group ">
				<button class="layui-btn layui-btn-mini add" href-url="<?php echo url('admin/type/add?pid='.$vo['id']); ?>">增加子分类</button>		
				<button class="layui-btn layui-btn-mini update" href-url="<?php echo url('admin/type/update?id='.$vo['id']); ?>">编辑</button>
				<?php if(($debug == true)): ?><button class="layui-btn layui-btn-mini del" href-url="<?php echo url('admin/type/delete?id='.$vo['id']); ?>">删除</button><?php endif; ?>
			</div>
		</td>
	</tr>
	<?php endforeach; endif; else: echo "" ;endif; ?>
